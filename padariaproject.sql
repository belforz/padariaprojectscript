...
create database padariaproject;
use padariaproject;
...
CREATE VIEW produtos_quantidades AS
SELECT
    idProduto AS id,
    Pnome AS nome_produto,
    SUM(valor_inicial + quantidade) AS valor_total_produto
FROM produto
GROUP BY idProduto, Pnome;

select * from produtos_quantidades;

--
-- Extraindo dados da tabela `produto`
--

ALTER TABLE produto ADD COLUMN imagem varchar(100);
